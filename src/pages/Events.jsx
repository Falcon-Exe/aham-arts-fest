...
export default function Events() {
    ...
    const filteredEvents = events.filter((event) => {
        ...
        const matchesTab = activeTab === "All" || (event.type || "On Stage") === activeTab;
        ...
        <div className="container events-page">
            ...
            <div className="dashboard-controls">
                ...
                <div className="team-filter-bar events-tabs">
                    {["On Stage", "Off Stage", "All"].map(tab => (
                        <button
                            key={tab}
                        ...
                        >
                            <span className="pill-name">
                                {tab === "On Stage" ? "🎭 On Stage" : tab === "Off Stage" ? "📝 Off Stage" : "🌐 All"}
                            </span>
                        </button>
                    ))}
                </div>
                    ...
                    {filteredEvents.map((event) => (
                        <div key={event.id} className="results-card event-card">
                            <div className="event-card-header">
                                ...
                                <span className={`type-badge badge-${(event.type || "On Stage").toLowerCase().replace(' ', '-')}`}>
                                    {event.type || "On Stage"}
                                </span>
                            </div>
